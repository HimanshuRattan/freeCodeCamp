...
NOTE: To take n "," separated inputs, use:
```
list = [i for i in input().split(",")]
```
Remember, this will store them as a string in a list. The loop with keep taking inputs until you press enter.
You can replace "," with space(" ") to take any number of space separated inputs.
